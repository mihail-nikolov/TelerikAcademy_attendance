...
namespace DefineClasses1
{
    class Program
    {
        static void Main()
        {
            ...
            //myGSM.Model = "siemens";
            Console.WriteLine(myGSM.Model);
            Battery myBat = new Battery("asda", 2, 3, BatType.NiCd);
            myBat.TheType = BatType.NiMH;
            Display myDispl = new Display(3, 256);
            Console.WriteLine(myDispl.NumberOfColors);
            myGSM.Display = myDispl;
            myGSM.Battery = myBat;
            myGSM.Owner = "Misho";
            myGSM.Price = 5;
            Console.WriteLine(myBat.TheType);
            ...
            GSMCallHistoryTest histTest = new GSMCallHistoryTest();
            histTest.HistoryTest();
        }
    }
}
