namespace Cars.Tests.JustMock
{
    ...
    public class CarsControllerTests
    {
        ...
        [TestMethod]
        public void VerifyCarsAreSortedByMake()
        {
             var expectedResult = new List<Car>
            {
             ...
             {
                 Assert.AreEqual(expectedResult[i].Make, cars[i].Make);
             }
        }

        [TestMethod]
        public void VerifyCarsAreSortedByDate()
        {
            var expectedResult = new List<Car>
             {
                new Car { Id = 1, Make = "Audi", Model = "A5", Year = 2005 },
            ...
            for (int i = 0; i < cars.Count; i++)
            {
                Assert.AreEqual(expectedResult[i].Year, cars[i].Year);
            }
        }
