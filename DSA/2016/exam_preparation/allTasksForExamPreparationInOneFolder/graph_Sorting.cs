...
//            bool sorted = CheckIfSorted(numbers);
//            if (sorted)
//            {
//                Console.WriteLine(0);
//                return;
//            }
//            bool sortedInDesc = CheckIfSortedInDescending(numbers);
//            if (sorted)
//            {
//                Console.WriteLine(1);
//                return;
...
//        static bool CheckIfSorted(List<int> numbers)
//        {
...
//        static bool CheckIfSortedInDescending(List<int> numbers)
//        {
//            for (int i = 1; i < numbers.Count; i++)
//            {
//                if (numbers[i] > numbers[i - 1])
